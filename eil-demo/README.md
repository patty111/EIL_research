...
watching VoucherIssued for 0xfDC7DcA57960FDa77ED2d1ed6017FBDFDDd32631/0 on chain 42161
   Batch 0: executing
   Batch 1: voucherIssued
   Batch 0: done (tx: 0x41190e7f985f7923...)
   Batch 1: waitingForVouchers
   Batch 1: executing
...
2. For simplicity, the example did not impl the reclaiming logic of the XLP (XLP取回提供的流動性與獎勵)
